...
use crate::generated::types::CancelSubscriptionNowData;
...
impl CancelSubscriptionNow {
    pub fn instruction(&self, args: CancelSubscriptionNowInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new_readonly(self.merchant, true));
        ...
        let mut data = CancelSubscriptionNowInstructionData::new().try_to_vec().unwrap();
...
impl<'a, 'b> CancelSubscriptionNowCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new_readonly(*self.merchant.key, true));
